...
def build_sam3_image_model(
    ...
    eval_mode=True,
    checkpoint_path="/home/610-ltf/DL/models/sam3/checkpoints/facebook/sam3/sam3.pt",
    load_from_HF=False,
...
def download_ckpt_from_hf():
    import os
    # 强制返回本地权重路径
    local_ckpt = "/home/ltf/pyfile/DL/segment/sam3/checkpoints/facebook/sam3/sam3.pt"
    if not os.path.exists(local_ckpt):
        raise RuntimeError(f"SAM3 模型权重不存在: {local_ckpt}")
    return local_ckpt
